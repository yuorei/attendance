...
type AttendanceLogInputPort interface {
	...
	GetWorkplaceBindingsByUser(ctx context.Context, teamId, userId string) ([]domain.WorkplaceBindings, error)
...
type AttendanceLogRepository interface {
	...
	DBGetWorkplaceBindingsByUser(ctx context.Context, teamId, userId string) ([]domain.WorkplaceBindings, error)
